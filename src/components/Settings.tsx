        ...
        <div className="space-y-6">
          ...
          <Card className="steel-card">
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-steel-600">Last Backup:</span>
                <span className="font-medium">2024-06-17</span>
              </div>
              <div className="flex justify-between">
                <span className="text-steel-600">Storage Used:</span>
                <span className="font-medium">2.3 GB</span>
              </div>
              <div className="flex justify-between">
                <span className="text-steel-600">Database:</span>
